...
topic = "is homework to students a good thing?"
word_limit = 30 
...
#`top_k_results`=2 as part of the `tool_kwargs` to prevent results from overflowing the context limit
